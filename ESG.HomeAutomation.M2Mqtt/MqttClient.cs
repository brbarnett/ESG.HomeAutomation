...
using ESG.HomeAutomation.M2Mqtt.Exceptions;
using ESG.HomeAutomation.M2Mqtt.Messages;
using ESG.HomeAutomation.M2Mqtt.Utility;

namespace ESG.HomeAutomation.M2Mqtt
{
    /// <summary>
    /// MQTT Client
    /// </summary>
    public class MqttClient
    {
        ...
        /// <param name="qosLevelAtLeastOnce"></param>
        /// <returns>Message Id related to PUBLISH message</returns>
        public ushort Publish(string topic, byte[] message, byte qosLevelAtLeastOnce)
        {
