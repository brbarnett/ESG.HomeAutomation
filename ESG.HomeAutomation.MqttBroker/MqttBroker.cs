...
using System.Linq;
using System.Text;
using ESG.HomeAutomation.MqttBroker.Communication;
using ESG.HomeAutomation.MqttBroker.Exceptions;
using ESG.HomeAutomation.MqttBroker.Managers;
using ESG.HomeAutomation.MqttBroker.Messages;

namespace ESG.HomeAutomation.MqttBroker
{
    /// <summary>
