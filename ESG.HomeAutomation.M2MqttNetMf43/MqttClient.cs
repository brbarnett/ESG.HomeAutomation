...
using ESG.HomeAutomation.M2MqttNetMf43.Exceptions;
using ESG.HomeAutomation.M2MqttNetMf43.Messages;
using ESG.HomeAutomation.M2MqttNetMf43.Utility;
using Microsoft.SPOT;
using Trace = ESG.HomeAutomation.M2MqttNetMf43.Utility.Trace;

namespace ESG.HomeAutomation.M2MqttNetMf43
{
    /// <summary>
    /// MQTT Client
    /// </summary>
